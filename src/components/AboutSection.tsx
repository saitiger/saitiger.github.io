    ...
    <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-12">
        <div className="flex-shrink-0">
          <img alt="Brain GIF" className="w-64 h-64 rounded-lg object-cover shadow-lg" src="https://i.gifer.com/75ez.gif" />
        </div>
        <div className="prose prose-lg max-w-none text-muted-foreground leading-relaxed">
          ...
          <p className="text-lg mb-6">I humanize data through storytelling data driven solutions. Over the years I have had incredible opportunities to learn and work in various domains alongside remarkable individuals expanding my knowledge. </p>
          
          <p className="text-lg">When I'm not analyzing data or reading about the latest business strategies, you'll find me coding side projects that solve my own pain points. There's something therapeutic about turning a weekend frustration into a functioning piece of software. These projects keep me grounded in the craft of building and remind me why I fell in love with programming in the first place.



When I am not coding, I love to spend my time hiking or watching sports in one form or the other (P.S. When there are no live events I rewatch the classics time and again)</p>
        </div>
      </div>
    </div>
  </section>;
