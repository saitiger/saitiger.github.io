...
const HeroSection = () => {
  ...
  return (
    <section className={`min-h-screen flex flex-col lg:flex-row items-center justify-center gap-12 py-16 max-w-7xl mx-auto w-full transition-all duration-1000 ease-out ${
